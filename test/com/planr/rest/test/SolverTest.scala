...
class SolverTest extends AsyncFunSuite {
  ...
  test("Solver - No resource key for operation") {
    ...
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_NoResourceKey.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
  ...
  test("Solver - No day frame") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_NoDayFrame.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - No resource for key") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_NoResourceForKey.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid operation grid") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidOperationGrid.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid same resource 1") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidSameResource1.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid same resource 2") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidSameResource2.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid same resource 3") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidSameResource3.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid enforced time interval 1") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidEnforcedTimeInterval1.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid enforced time interval 2") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidEnforcedTimeInterval2.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid enforced time interval 3") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidEnforcedTimeInterval3.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid operations relation 1") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidOperationsRelation1.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid operations relation 2") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidOperationsRelation2.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid preferred time interval 1") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidPreferredTimeInterval1.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid preferred time interval 2") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidPreferredTimeInterval2.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
  ...
  test("Solver - Invalid preferred time interval 3") {
    assert(isSuccessfulInit)
    JsonUtil.jsonFileToCaseClass[Problems]("jsons/Problems_InvalidPreferredTimeInterval3.json") match {
      case Left(_) =>
        fail()
      case Right(problems) =>
        val solutions = solve(problems)
